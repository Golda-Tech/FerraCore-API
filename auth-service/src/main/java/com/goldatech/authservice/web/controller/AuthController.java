...
public class AuthController {
    ...
    public ResponseEntity<UserProfileResponse> initiateRoleUpdate(
            Authentication authentication,
            @RequestParam(name = "requestedRole") String requestedRole) {
        log.warn("Initiating Role update for authenticated user, requestedRole={}", requestedRole);
        String email = authentication.getName();
